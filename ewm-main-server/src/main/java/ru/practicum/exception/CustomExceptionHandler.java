...
public class CustomExceptionHandler {
    ...
    public ApiError handleConflict(ConflictException ex) {
        log.warn("Conflict exception has occurred. Message: {}", ex.getMessage());
    ...
    public ApiError handleForbiddenOperationException(ForbiddenOperationException ex) {
        log.warn("Forbidden operation detected. Message: {}", ex.getMessage());
    ...
    public ApiError handleValidationException(Exception ex) {
        log.warn("Validation exception has occurred. Message: {}", ex.getMessage());
        return new ApiError(
                ex.getMessage(),
                "Validation failed",
                "BAD_REQUEST"
