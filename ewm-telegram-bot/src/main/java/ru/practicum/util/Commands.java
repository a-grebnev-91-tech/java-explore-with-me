...
public class Commands {
    ...
    public static final String AVAILABLE_COMMANDS_MESSAGE = "Для вас доступны следующие комманды:\n";
    ...
    public static final String SUBSCRIBE_EVENT_PUBLISHED_MESSAGE = "Теперь вы будете получать уведомления " +
